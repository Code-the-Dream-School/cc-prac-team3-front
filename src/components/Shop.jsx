    ...
    /**
      ...
      * Con dependencies [userToken]: se ejecutara cada vez que userToken cambie: Antes era null, ahora es igual a: ejy....
      */
    useEffect(() => {
      if(userToken) {
        axios.get(`${process.env.REACT_APP_SERVICE_ENDPOINT}/products`,{ headers:{Authorization:`Bearer ${userToken}`}})
